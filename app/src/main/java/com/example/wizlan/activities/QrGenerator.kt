...
import kotlinx.android.synthetic.main.activity_qr_generator.logoQrgenScreen
import java.io.File
import java.io.FileOutputStream

class qrGenerator : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logoQrgenScreen.setOnClickListener {
